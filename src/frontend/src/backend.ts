...
export class Backend implements backendInterface {
    ...
    async addFile(arg0: string, arg1: string, arg2: string, arg3: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.addFile(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getFeatured(): Promise<Array<FileItem>> {
        if (this.processError) {
            try {
    ...
    async getFilesByCategory(arg0: string): Promise<Array<FileItem>> {
        if (this.processError) {
            try {
                const result = await this.actor.getFilesByCategory(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getNotice(): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.getNotice();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async setNotice(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setNotice(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateFile(arg0: bigint, arg1: string, arg2: string, arg3: string, arg4: string, arg5: boolean): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateFile(arg0, arg1, arg2, arg3, arg4, arg5);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async verifyAccessPassword(arg0: string): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.verifyAccessPassword(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
